...
class Epicor_Comm_Adminhtml_Epicorcomm_Mapping_CurrencyController extends Epicor_Comm_Controller_Adminhtml_Abstract {

    protected $_aclId = 'epicor_common/mapping/currency';

    protected function _initAction() {
        $this->loadLayout()
                ->_setActiveMenu('epicor_comm/mapping/currency')
                ->_addBreadcrumb(Mage::helper('adminhtml')->__('Currency Mapping'),Mage::helper('adminhtml')->__('Currency Mapping'));
        return $this;
    }
    ...
    public function editAction() {
        ...
        $model = Mage::getModel('epicor_comm/erp_mapping_currency');
        if ($id) {
            $model->load($id);
        ...
        Mage::register('currency_mapping_data', $model);
