 ...
 */
class Epicor_Comm_Block_Adminhtml_Sales_Order_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        $creditMemosOfflineAllowed = Mage::getStoreConfigFlag('sales/order_credit_memo/options');
