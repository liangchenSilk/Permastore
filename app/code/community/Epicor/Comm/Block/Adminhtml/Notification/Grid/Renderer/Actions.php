 ...
 */
class Epicor_Comm_Block_Adminhtml_Notification_Grid_Renderer_Actions
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    {
        $full_url = Mage::getModel('epicor_comm/adminnotification_inbox')->getUrl($row->getUrl()); 
        $readDetailsHtml = ($full_url)
