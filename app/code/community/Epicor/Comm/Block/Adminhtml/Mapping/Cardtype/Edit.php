...
class Epicor_Comm_Block_Adminhtml_Mapping_Cardtype_Edit extends Epicor_Common_Block_Adminhtml_Mapping_Default_Edit
{
    ...
    {
        if (Mage::registry('cardtype_mapping_data') && Mage::registry('cardtype_mapping_data')->getMagentoId())
        {
            $title=Mage::registry('cardtype_mapping_data')->getMagentoId();
