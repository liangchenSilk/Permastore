...
class Epicor_Comm_Block_Adminhtml_Mapping_Country_Grid extends Epicor_Common_Block_Adminhtml_Mapping_Default_Filter
{
  ...
  {
      $collection = Mage::getModel('epicor_comm/erp_mapping_country')->getCollection();
  ...
  protected function _prepareColumns()
  {
      $this->addColumn('magento_id', array(
          ...
          'align'     =>'left',
          'index'     => 'magento_id',
          'renderer'  => new Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Country()
      ...
      $this->addColumn('erp_code', array(
          'header'    => Mage::helper('epicor_comm')->__('ERP Country Code'),
          'align'     =>'right',
          'width'     => '50px',
          'index'     => 'erp_code',
      ));
