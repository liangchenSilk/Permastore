...
class Epicor_Comm_Block_Adminhtml_Mapping_Currency_Edit extends Epicor_Common_Block_Adminhtml_Mapping_Default_Edit
{
    ...
    {
        if (Mage::registry('currency_mapping_data') && Mage::registry('currency_mapping_data')->getMagentoId())
        {
            $title=Mage::registry('currency_mapping_data')->getMagentoId();
