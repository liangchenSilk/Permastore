...
class Epicor_Comm_Block_Adminhtml_Mapping_Country_Edit extends Epicor_Common_Block_Adminhtml_Mapping_Default_Edit
{
    ...
    {
        if (Mage::registry('country_mapping_data') && Mage::registry('country_mapping_data')->getMagentoId())
        {
            $title=Mage::registry('country_mapping_data')->getMagentoId();
