...
$element = $helper->addAccessElement('Epicor_Comm', 'Configurator', 'loadewa', '', 'Access', 0);
$helper->addAccessRightElementById($right->getId(), $element->getId());

$element = $helper->addAccessElement('Epicor_Comm', 'Configurator', 'ewacss', '', 'Access', 0);
$helper->addAccessRightElementById($right->getId(), $element->getId());

$element = $helper->addAccessElement('Epicor_Comm', 'Configurator', 'ewacomplete', '', 'Access', 0);
$helper->addAccessRightElementById($right->getId(), $element->getId());
