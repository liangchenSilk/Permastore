 ...
 */
class Epicor_HostingManager_Block_Adminhtml_Nginxlog_View extends Mage_Adminhtml_Block_Widget_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_logFileDir = $logFilePath = DS . 'var' . DS . 'log' . DS . 'nginx' . DS;
