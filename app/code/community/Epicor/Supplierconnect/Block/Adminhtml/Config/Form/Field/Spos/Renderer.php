...
class Epicor_Supplierconnect_Block_Adminhtml_Config_Form_Field_Spos_Renderer extends Mage_Core_Block_Html_Select {
    ...
    public function _toHtml() {
        if (!$this->getOptions()) {
            ...
            $this->addOption('Epicor_Supplierconnect_Block_Customer_Orders_List_Renderer_Erporderstatus', $this->__('Erp Order Status'));
