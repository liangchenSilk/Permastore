...
class Epicor_Supplierconnect_Block_Adminhtml_Config_Form_Field_Spos_Mapping extends Mage_Core_Block_Html_Select {
    ...
    public function _toHtml() {
        if (!$this->getOptions()) {
            ...
            $this->addOption('new_po_confirm', $this->__('New PO Confirm'));
            $this->addOption('new_po_reject', $this->__('New PO Reject'));
        }
