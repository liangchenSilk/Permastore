...
class Epicor_Customerconnect_Block_Adminhtml_Mapping_Erporderstatus_Grid extends Epicor_Common_Block_Adminhtml_Mapping_Default_Filter {
    ...
    protected function _prepareColumns() {
        $this->addColumn('code', array(
            'header' => Mage::helper('customerconnect')->__('ERP Order Status Code'),
            'align' => 'left',
            'index' => 'code',
            'width' => '50px'
        ));
...
//            'header' => Mage::helper('customerconnect')->__('Order State'),
//            'align' => 'left',
//            'index' => 'state',
//            'width' => '50px'
//        ));
        $this->addColumn('status', array(
            'header' => Mage::helper('customerconnect')->__('Order Status'),
            'align' => 'left',
            'index' => 'status',
            'width' => '50px'
        ));
