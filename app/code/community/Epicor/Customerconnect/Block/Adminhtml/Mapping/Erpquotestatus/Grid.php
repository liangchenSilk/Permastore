...
class Epicor_Customerconnect_Block_Adminhtml_Mapping_Erpquotestatus_Grid
        extends Epicor_Common_Block_Adminhtml_Mapping_Default_Filter
{
    ...
    {
        $collection = Mage::getModel('customerconnect/erp_mapping_erpquotestatus')->getCollection();
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('code', array(
            'header' => Mage::helper('customerconnect')->__('ERP Quote Status Code'),
            'align' => 'left',
            'index' => 'code',
            'width' => '50px'
        ));
...
//        ));
        $this->addColumn('status', array(
            'header' => Mage::helper('customerconnect')->__('Quote Status'),
            'align' => 'left',
            'index' => 'status',
            'width' => '50px'
        ));
