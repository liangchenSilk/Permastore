...
class Epicor_Customerconnect_Block_Adminhtml_Mapping_Invoicestatus_Grid extends Epicor_Common_Block_Adminhtml_Mapping_Default_Filter {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('customerconnect/erp_mapping_invoicestatus')->getCollection();
    ...
    protected function _prepareColumns() {
        $this->addColumn('code', array(
            'header' => Mage::helper('customerconnect')->__('Invoice Status Code'),
            'align' => 'left',
            'index' => 'code',
            'width' => '50px'
        ));
...
//        ));
        $this->addColumn('status', array(
            'header' => Mage::helper('customerconnect')->__('Invoice Status'),
            'align' => 'left',
            'index' => 'status',
            'width' => '50px'
        ));
