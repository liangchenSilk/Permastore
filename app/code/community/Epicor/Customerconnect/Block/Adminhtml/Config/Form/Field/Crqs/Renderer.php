...
class Epicor_Customerconnect_Block_Adminhtml_Config_Form_Field_Crqs_Renderer
        extends Mage_Core_Block_Html_Select
{
    ...
    public function _toHtml()
    {
        if (!$this->getOptions()) {
            ...
            $this->addOption('Epicor_Customerconnect_Block_List_Renderer_Erpquotestatus', $this->__('Erp Quote Status'));
