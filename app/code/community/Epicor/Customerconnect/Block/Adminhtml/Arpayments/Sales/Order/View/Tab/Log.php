 ...
 * 
 */
class Epicor_Customerconnect_Block_Adminhtml_Arpayments_Sales_Order_View_Tab_Log extends Mage_Adminhtml_Block_Widget_Grid implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    
    public function __construct($attributes = array())
    {
        parent::__construct($attributes);
        $this->setId('arorder_message_log');
    ...
    protected function _prepareCollection()
    {
        ...
        //$collection->addFieldToFilter('message_category', 'Other');
        $collection->addFieldToFilter('message_secondary_subject', array(
            'like' => '%ARPAYMENTS Quote ID:' . $orderId . '%'
        ));
    ...
    protected function _prepareColumns()
    {
        $this->addColumn('message_type', array(
            'header' => Mage::helper('epicor_comm')->__('Message Types'),
            'align' => 'left',
            'index' => 'message_type'
        ));
    ...
    {
        return $this->getUrl('adminhtml/arpayments/loggrid', array(
            '_current' => true
        ));
    }
