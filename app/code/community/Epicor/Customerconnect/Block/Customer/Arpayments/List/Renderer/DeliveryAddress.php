...
/**
 * AR Payment Delivery Address  link grid renderer
 * 
 * @category   Epicor
 * @package    Epicor_Customerconnect
 * @author     Epicor Websales Team
 */
class Epicor_Customerconnect_Block_Customer_Arpayments_List_Renderer_DeliveryAddress extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Input
{
    ...
    public function render(Varien_Object $row)
    {
        ...
        $id = $row->getId();
        if (!empty($id)) {
            $addresses = Mage::helper('epicor_common/xml')->varienToArray($row->getDeliveryAddress());
