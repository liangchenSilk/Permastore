<?php
/**
 * AR Payments Info Page
 *
 * @category   Epicor
 * @package    Epicor_Customerconnect
 * @author     Epicor Websales Team
 */
class Epicor_Customerconnect_Block_Customer_Arpayments_Info extends Mage_Core_Block_Template
{
    ...
    {
        parent::_construct();
        $this->setTemplate('customerconnect/arpayments/sales/order/info.phtml');
    }
