 ...
 */
class Epicor_Customerconnect_Block_Customer_Arpayments_Details_Data extends Epicor_Customerconnect_Block_Customer_Info
{
    ...
    public function _construct()
    {
        ...
        $this->setTemplate('customerconnect/arpayments/invoices/info.phtml');
    }
