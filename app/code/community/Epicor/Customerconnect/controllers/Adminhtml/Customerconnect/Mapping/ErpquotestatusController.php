...
class Epicor_Customerconnect_Adminhtml_Customerconnect_Mapping_ErpquotestatusController extends Epicor_Comm_Controller_Adminhtml_Abstract
{
    protected $_aclId = 'customerconnect/mapping/erpquotestatus';

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('customerconnect/mapping/erpquotestatus')
			->_addBreadcrumb(Mage::helper('adminhtml')->__('Erp Quote Status Mapping'),Mage::helper('adminhtml')->__('Erp Quote Status Mapping'));
		return $this;
	}   
    ...
    public function editAction()
    {
        ...
        Mage::register('erpquotestatus_mapping_data', $model);
    ...
    public function saveAction()
    {
        if ($data = $this->getRequest()->getPost())
        {
            ...
            $statusModel = Mage::getModel('customerconnect/config_source_quotestatus');
