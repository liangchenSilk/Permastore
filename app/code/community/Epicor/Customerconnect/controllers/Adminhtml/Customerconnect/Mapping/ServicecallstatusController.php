...
class Epicor_Customerconnect_Adminhtml_Customerconnect_Mapping_ServicecallstatusController extends Epicor_Comm_Controller_Adminhtml_Abstract
{
    protected $_aclId = 'customerconnect/mapping/servicecallstatus';

	protected function _initAction() {
		$this->loadLayout()
			->_setActiveMenu('customerconnect/mapping/servicecallstatus')
			->_addBreadcrumb(Mage::helper('adminhtml')->__('Service Call Status Mapping'),Mage::helper('adminhtml')->__('Servicecall Status Mapping'));
		return $this;
	}   
    ...
    public function editAction()
    {
        ...
        $model = Mage::getModel('customerconnect/erp_mapping_servicecallstatus');
        if ($id) {
            $model->load($id);            
            if ($model->getCode()) {
        ...
        Mage::register('servicecallstatus_mapping_data', $model);
