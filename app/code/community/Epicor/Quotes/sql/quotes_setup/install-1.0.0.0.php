...
$table->addColumn('expires', Varien_Db_Ddl_Table::TYPE_DATE, null, array(), 'Expiry Date');
...
$table->addColumn('send_reminder', Varien_Db_Ddl_Table::TYPE_BOOLEAN, null, array(
    'nullable' => false,
    'default' => TRUE
),'Send Reminder');

$table->addColumn('show_prices', Varien_Db_Ddl_Table::TYPE_BOOLEAN, null, array(
    'nullable' => false,
    'default' => TRUE
),'Show Prices');

$table->addColumn('is_private', Varien_Db_Ddl_Table::TYPE_BOOLEAN, null, array(
    'nullable' => false,
    'default' => FALSE
),'Private Message');

$table->addColumn('is_visible', Varien_Db_Ddl_Table::TYPE_BOOLEAN, null, array(
    'nullable' => false,
    'default' => FALSE
),'Visible Message');

$table->addColumn('quote_number', Varien_Db_Ddl_Table::TYPE_TEXT, 100, array(),'ERP Quote Number');
...
$table->addColumn('orig_price',Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,4', array(
        'nullable'  => false,
        ), 'Original Price');
$table->addColumn('new_qty',Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(), 'New Quantity');
$table->addColumn('new_price',Varien_Db_Ddl_Table::TYPE_DECIMAL, '12,4', array(), 'New Price');
$table->addColumn('note',Varien_Db_Ddl_Table::TYPE_TEXT, null, array(), 'Note');
$table->addColumn('erp_note_ref', Varien_Db_Ddl_Table::TYPE_TEXT, 100, array(),'ERP Reference');
$table->addIndex(
        $installer->getIdxName(
...
$table->addColumn('erp_ref', Varien_Db_Ddl_Table::TYPE_TEXT, 100, array(),'ERP Reference');
